        ...
        <dh-component>
            <div class="flex flex-no-wrap">
                ...
                <div style="min-height: 100vh; position: fixed" class="w-64 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex">
                    <div class="px-8">
                        ...
                        <ul class="mt-12">
                            ...
                            <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                                <a href="<?= site_url('relasi/index') ?>" class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-puzzle" width="18" height="18" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z"></path>
                                        <path d="M4 7h3a1 1 0 0 0 1 -1v-1a2 2 0 0 1 4 0v1a1 1 0 0 0 1 1h3a1 1 0 0 1 1 1v3a1 1 0 0 0 1 1h1a2 2 0 0 1 0 4h-1a1 1 0 0 0 -1 1v3a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-1a2 2 0 0 0 -4 0v1a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1h1a2 2 0 0 0 0 -4h-1a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1"></path>
                                    </svg>
                ...
                <div class="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6 mr-6">
                    <h2 class="text-xl font-bold text-teal-700 mb-4">Edit Penyakit</h2>

                    <form action="<?= base_url('/penyakit/update_penyakit/' . $penyakit['kode_penyakit']) ?>" method="POST">
                        <?= csrf_field() ?>

                        <div class="mb-4">
                            <label for="kode_penyakit" class="block text-gray-700">Kode Penyakit</label>
                            <input type="text" name="kode_penyakit" id="kode_penyakit" value="<?= $penyakit['kode_penyakit'] ?>" placeholder="Masukkan Kode Penyakit" class="form-input w-96 bg-gray-200 border border-gray-300 rounded-md p-2" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="penyakit" id="penyakit" value="<?= $penyakit['penyakit'] ?>" placeholder="Masukkan Penyakit" class="form-input w-96 bg-gray-200 border border-gray-300 rounded-md p-2" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="deskripsi_penyakit" id="deskripsi_penyakit" placeholder="Masukkan Deskripsi Penyakit" class="form-input w-96 bg-gray-200 border border-gray-300 rounded-md p-2" required><?= $penyakit['deskripsi_penyakit'] ?></textarea>
                            <?= session('errors.deskripsi_penyakit') ? '<p class="text-red-500">' . session('errors.deskripsi_penyakit') . '</p>' : '' ?>
                        </div>

                        <div>
                            <button type="submit" class="bg-teal-700 hover:bg-teal-500 text-gray-100 px-4 py-2 rounded text-sm transition duration-100">Update Penyakit</button>
                        </div>
                    </form>
