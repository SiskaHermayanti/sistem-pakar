        ...
        <dh-component>
            <div class="flex flex-no-wrap">
                ...
                <div class="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6 mr-6">
                    <h2 class="text-xl font-bold text-sky-700">Tabel Solusi Pengobatan</h2>
                <div class="flex items-center space-x-2 mt-2 mb-2">
                    <a href="<?= site_url('/solusi/create_solusi') ?>" type="button" class="flex items-center bg-sky-700 hover:bg-sky-500 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
