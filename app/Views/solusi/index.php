        ...
        <dh-component>
            <div class="flex flex-no-wrap">
                ...
                <div class="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6 mr-6">
                    <h2 class="text-xl font-bold text-teal-700">Tabel Solusi Pengobatan</h2>
                <div class="flex items-center space-x-2 mt-2 mb-2">
                    <a href="<?= site_url('/solusi/create_solusi') ?>" type="button" class="flex items-center bg-teal-700 hover:bg-teal-500 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
                ...
                <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4 font-medium text-white">Solusi Pengobatan</th>
                    ...
                    <?php foreach ($solusi as $key => $value) : ?>
                            <tr>
                                ...
                                <td class="px-6 py-4"><?= $value['solusi_pengobatan'] ?></td>
                                <td class="px-6 py-4">
                                    <a href="<?= base_url('/solusi/edit_solusi/' . $value['id_solusi']) ?>">
                                        <button>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    ...
                                    <a href="<?= base_url('/solusi/hapus_solusi/' . $value['id_solusi']) ?>">
                                        <button>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
