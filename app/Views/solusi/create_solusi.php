        ...
        <dh-component>
            <div class="flex flex-no-wrap">
                ...
                <div style="min-height: 100vh; position: fixed" class="w-64 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex">
                    <div class="px-8">
                        ...
                        <ul class="mt-12">
                            ...
                            <li class="flex w-full justify-between text-gray-400 text-gray-300 cursor-pointer items-center mb-6">
                ...
                <div class="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6 mr-6">
                    <h2 class="text-xl font-bold text-teal-700 mb-4">Tambah Solusi Pengobatan</h2>
                
                    <form action="<?= base_url('/solusi/store')?>" method="post">
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="solusi_pengobatan" id="solusi_pengobatan" placeholder="Masukkan Solusi Pengobatan" class="form-input w-full h-32 bg-gray-200 border border-gray-300 rounded-md p-2" required><?= old('solusi_pengobatan') ?></textarea>
                            <?= session('errors.solusi_pengobatan') ? '<p class="text-red-500">' . session('errors.solusi_pengobatan') . '</p>' : '' ?>
                        </div>

                        <div>
                            <button type="submit" class="bg-teal-700 hover:bg-teal-500 text-gray-100 px-4 py-2 rounded text-sm transition duration-100">Tambah Solusi Pengobatan</button>
                        </div>
                    </form>
