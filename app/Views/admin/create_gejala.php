        ...
        <dh-component>
            <div class="flex flex-no-wrap">
                ...
                <div class="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6 mr-6">
                    <h2 class="text-xl font-bold text-teal-700 mb-4">Tambah Gejala</h2>
                
                    <form action="<?= base_url('/admin/tambahgejala') ?>" method="post">
                        <div class="mb-4">
                            <label for="kode_gejala" class="block text-gray-700">Kode Gejala</label>
                            <input type="text" name="kode_gejala" id="kode_gejala" value="<?= old('kode_gejala') ?>" placeholder="Masukkan Kode Gejala" class="form-input w-96 bg-gray-200 border border-gray-300 rounded-md p-2" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="gejala" id="gejala" value="<?= old('gejala') ?>" placeholder="Masukkan Gejala" class="form-input w-96 bg-gray-200 border border-gray-300 rounded-md p-2" required>
                            <?= session('errors.gejala') ? '<p class="text-red-500">' . session('errors.gejala') . '</p>' : '' ?>
                        </div>

                        <div>
                            <button type="submit" class="bg-teal-700 hover:bg-teal-500 text-gray-100 px-4 py-2 rounded text-sm transition duration-100">Tambah Gejala</button>
                        </div>
                    </form>
                </div>
            </div>   
