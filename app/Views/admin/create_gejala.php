        ...
        <dh-component>
            <div class="flex flex-no-wrap">
                ...
                <div class="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6 mr-6">
                    <h2 class="text-xl font-bold text-sky-700 mb-4">Tambah Gejala</h2>
                    ...
                    <form action="<?= base_url('/admin/tambahgejala') ?>" method="post">
                        ...
                        <div>
                            <button type="submit" class="bg-sky-700 hover:bg-sky-500 text-gray-100 px-4 py-2 rounded text-sm transition duration-100">Tambah Gejala</button>
                        </div>
                    </form>
                </div>
            </div>   
