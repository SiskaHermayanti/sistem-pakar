        ...
        <dh-component>
            <div class="flex flex-no-wrap">
                ...
                <div class="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6 mr-6">
                    <h2 class="text-xl font-bold text-teal-700">Masukkan Gejala untuk Diagnosis</h2>
                <div class="flex items-center space-x-2 mt-2 mb-2">
                    ...
                    <form action="<?= site_url('diagnosis/diagnose') ?>" method="post">
                        ...
                        <button class="flex items-center bg-teal-700 hover:bg-teal-500 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100" type="submit">Diagnosis</button>
