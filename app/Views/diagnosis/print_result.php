...
<body>
    <div class="container mx-auto py-10 md:w-4/5 w-11/12 px-6">
        <h2 class="text-2xl font-bold text-teal-700 mb-6">Hasil Diagnosis</h2>
        ...
        <div class="flex flex-col md:flex-row items-center space-x-4 mt-4">
            <div class="md:w-1/2">
                ...
                <p class="font-semibold text-2xl text-teal-900 mb-4"><?= $penyakit ?></p>

                <p class="mb-2 text-lg">Deskripsi Penyakit:</p>
                <!-- Tampilkan hasil diagnosis dari variabel PHP -->
                <p class="font-semibold text-2xl text-teal-900 mb-4"><?= $deskripsi_penyakit ?></p>
