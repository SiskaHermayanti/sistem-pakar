        ...
        <dh-component>
            <div class="flex flex-no-wrap">
                ...
                <div class="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6 mr-6">
                    <h2 class="text-xl font-bold text-teal-700 mb-4">Hasil Diagnosis</h2>
                    
                    <div class="flex flex-col md:flex-row items-center space-x-2 mt-2 mb-6">
                        <div class="md:w-1/2">
                            <p class="mb-2">Penyakit kulit yang diderita adalah:</p>
                            <p class="font-bold mb-4"><?= $penyakit ?></p>

                            <p class="mb-2">Deskripsi Penyakit:</p>
                            <p class="font-bold mb-4"><?= $deskripsi_penyakit ?></p>
                            
                            <p class="mb-2">Solusi Pengobatan:</p>
                            <p class="font-bold"><?= $solusi ?></p>
                        </div>
                    </div>
                    
                    <!-- Tombol cetak ditempatkan di bawah -->
                    <div class="md:w-1/2 mt-4 md:mt-0">
                        <button onclick="printPage()" class="bg-teal-700 hover:bg-teal-500 text-gray-100 px-4 py-2 rounded text-sm transition duration-100">
                            Cetak
                        </button>
                    </div>
                </div>
